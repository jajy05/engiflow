...
const EditProjectModal: React.FC<EditProjectModalProps> = ({ onClose, onUpdateProject, project, users }) => {
            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                <div>
                 ...
                 <div>
                    <label htmlFor="project-code" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Project Code (Read-only)</label>
                    <input
                        id="project-code"
                        type="text"
                        value={project.projectCode}
                        readOnly
                        className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md cursor-not-allowed"
                    />
                </div>
                 <div>
